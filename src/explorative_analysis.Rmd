...
table 1 of included variables or hmisc plots? summarytools?

univariate dists of signigicant:
  -physical condition 
  -life quality
  that line change plot?
...
tab3Mat %>% 
  kable()
  write.csv(tab3Mat, file = "../results/table_1_populationExp_20200512.csv")
