...
## Plot ferritin and donation frequency 

```{r}
pdata <- pdata %>% mutate(ferritin =  Ferritin_beginning  )
p <- ggplot(aes(y= ferritin, x = donation_frequency), data=pdata) +
  # geom_hline(yintercept = 15, color = "red", linetype = 3)
  ...
  #geom_beeswarm(alpha = 0.5, shape = 1) +
  scale_y_log10() +
  facet_grid(group ~ phys_cond_d,scales="free") +
  theme_bw() +
  theme(legend.position = "none") +
#  ggtitle("Evolution of self-rated health")+
  xlab("Donation frequency") +
  ylab("Ferritin (ug/l)") +
  #geom_text(stat='count', aes(label=..count..),color="black", vjust=1) +
...
ggplot2::ggsave(plot=p,filename = "../results/figures/fer_donfreq_physd.pdf",
       width = fig.width,
       height = fig.height,
       dpi = 600,
       units = "cm")
...
p <- ggplot(aes(y= ferritin, x = donation_frequency), data=pdata) +
  ...
  #geom_beeswarm(alpha = 0.5, shape = 1) +
  scale_y_log10() +
  facet_grid(group ~ Difference,scales="free") +
  theme_bw() +
  theme(legend.position = "none") +
#  ggtitle("Evolution of self-rated health")+
  xlab("Donation frequency") +
...
ggplot2::ggsave(plot=p,filename = "../results/figures/fer_donfreq_health.pdf",
       width = fig.width,
       height = fig.height,
       dpi = 600,
       units = "cm")
...
```{r}
pdata <- pdata %>% mutate(ferritin =  Ferritin_beginning  )
p <- ggplot(aes(y= ferritin, x = donation_frequency,color=group), data=pdata) +
  # geom_hline(yintercept = 15, color = "red", linetype = 3)
  geom_point()+
  ...
  #geom_beeswarm(alpha = 0.5, shape = 1) +
  scale_y_log10() +
  facet_grid(Difference ~ phys_cond_d,scales="free") +
  theme_bw() +
  theme(legend.position = "none") +
#  ggtitle("Evolution of self-rated health")+
  xlab("Donation frequency") +
...
ggplot2::ggsave(plot=p,filename = "../results/figures/fer_donfreq_phys_d_health.pdf",
       width = fig.width,
       height = fig.height,
       dpi = 600,
       units = "cm")
