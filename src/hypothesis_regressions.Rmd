...
tab3Mat %>% 
  kable()
  write.csv(tab3Mat, file = paste0("../results/table_1_population_20200512",gsub("-","",as.Date(Sys.time())),".csv"))
```
...
phb <- final_data %>% 
  ...
  ggplot(aes(x = Difference, y = Hb_v, color = group)) +
...
pfer <- final_data %>% 
  ...
  mutate(group = case_when(group == "Pre_menopause_women" ~ "Pre-menopausal \n women",
                           ...
                           TRUE ~ "Men"),
         group = ordered(group, levels = c(  "Men", "Post-menopausal \n women", "Pre-menopausal \n women") )) %>% 
  ggplot(aes(x = Difference, y = Ferritin_beginning, color = group)) +
  # geom_hline(yintercept = 15, color = "red", linetype = 3) +
  geom_boxplot(outlier.alpha = 0) +
  geom_beeswarm(alpha = 0.5, shape = 1) +
  # scale_y_log10() +
...
pbm <- final_data %>% 
  ...
  mutate(group = case_when(group == "Pre_menopause_women" ~ "Pre-menopausal \n women",
                           ...
                           TRUE ~ "Men"),
         group = ordered(group, levels = c(  "Men", "Post-menopausal \n women", "Pre-menopausal \n women") )) %>% 
  ggplot(aes(x = Difference, y = BMI_diff, color = group)) +
  # geom_hline(yintercept = 15, color = "red", linetype = 3) +
  geom_boxplot(outlier.alpha = 0) +
  geom_beeswarm(alpha = 0.5, shape = 1) +
  # scale_y_log10() +
...
pfq <- final_data %>% 
  ...
  mutate(group = case_when(group == "Pre_menopause_women" ~ "Pre-menopausal \n women",
                           ...
                           TRUE ~ "Men"),
         group = ordered(group, levels = c(  "Men", "Post-menopausal \n women", "Pre-menopausal \n women") )) %>% 
  ggplot(aes(x = Difference, y = nb_donations_between_questionnaires, color = group)) +
  # geom_hline(yintercept = 15, color = "red", linetype = 3) +
  geom_boxplot(outlier.alpha = 0) +
  geom_beeswarm(alpha = 0.5, shape = 1) +
  # scale_y_log10() +
  ...
  theme(legend.position = "none") +
  xlab("Evolution of self-rated health") +
  ylab("Number of donations between questionnaires") 
  #scale_y_log10() 
...
pwe <- final_data %>% 
  ...
  mutate(group = case_when(group == "Pre_menopause_women" ~ "Pre-menopausal \n women",
                           ...
                           TRUE ~ "Men"),
         group = ordered(group, levels = c(  "Men", "Post-menopausal \n women", "Pre-menopausal \n women") )) %>% 
  ggplot(aes(x = Difference, y = starting_weight, color = group)) +
  # geom_hline(yintercept = 15, color = "red", linetype = 3) +
  geom_boxplot(outlier.alpha = 0) +
  geom_beeswarm(alpha = 0.5, shape = 1) +
  # scale_y_log10() +
